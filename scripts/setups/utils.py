...
def run_premake():
  ...
  if system == "Windows":
    premake_exe = ".\\vendor\\premake5-x86_64-windows\\premake5.exe"
    premake_args = "vs2022"
  elif system == "Linux":
    premake_exe = "./vendor/premake5-x86_64-linux/premake5"
    premake_args = "gmake"
  elif system == "Darwin": # macos
    premake_exe = "./vendor/premake5-x86_64-macosx/premake5"
    premake_args = "xcode4"
  else:
